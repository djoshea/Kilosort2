...
irange1 = [2:nbins/2 (3/2*nbins+1):(2*nbins)]; % this index range corresponds to the CCG shoulders, outside of central CCG
irange2 = [nbins+1-50:nbins-10]; % these indices are the narrow, immediate shoulders, left of central CCG
